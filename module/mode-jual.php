...
function cetak($data)
{
    ...
    if ($DataAsli_Bayar == '') {
        echo "<script>
            ...
            window.location.href = 'index.php?tgl=' + encodeURIComponent('$tgl') + '&nojual=' + encodeURIComponent('$nojual');
        </script>";
        return false;
...
function service($data)
{
    ...
    $sqljual = "INSERT INTO tbl_jual_head VALUES ('$nojual','$tgl','$customer',$Total,'$keterangan','','')";
