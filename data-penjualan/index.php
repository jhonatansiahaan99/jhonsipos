...
$title = "Data Penjualan - Jhonsi Bengkel Motor";
require "../template/header.php";
require "../template/navbar.php";
require "../template/sidebar.php";

$penjualan = getData("SELECT * FROM tbl_jual_head ORDER BY NO_JUAL DESC");
                        ...
                        <tbody>
                            ...
                            foreach ($penjualan as $jual) { ?>
                                <tr>
                                    ...
                                    if ($jual['JML_BAYAR'] == 0 | $jual['KEMBALIAN'] == 0) {
                                    ?>
                                        <td class="text-center"> <b><?= "BELUM BAYAR" ?></b></td>
                                        <td class="text-center"><b><?= "KOSONG" ?></b></td>
                                    <?php
                                    } else {
                                    ?>
                                    ...
                                    ?>
                                    <td class="text-center"><a href="edit-data-penjualan.php?id=<?= $jual['NO_JUAL'] ?>&tgl=<?= $jual['TGL_JUAL'] ?>" class="btn btn-sm btn-info" title="Edit Data"><i class="fas fa-pen"></i></a></td>
                                </tr>
                            <?php
                            }
                            ?>
